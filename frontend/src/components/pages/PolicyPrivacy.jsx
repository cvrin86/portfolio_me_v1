...
const PolicyPrivacy = () => {
    return (
        <div className='privacy' id='top'>
            <h1>Politique de  confidentialité</h1>
            <p><strong>J’accorde une importance toute particulière au droit à la vie privée des internautes et m’engage à protéger leurs données personnelles selon la législation française et européenne en vigueur</strong></p>
            ...
            <section>
                ...
                <p>La présente Politique s’applique uniquement aux informations collectées à partir de mon Site et ne s’applique pas aux informations collectées à partir d’autres sources, notamment, sans que cette liste ne soit limitée, Facebook®, Twitter®, YouTube® ou tout autre site ou réseaux social tiers.</p>
                <p>En utilisant mon Site, vous acceptez les termes de la présente Politique. Si vous refusez les termes de la présente Politique, je vous invite à ne pas utiliser mon Site ou à ne pas me transmettre d’information à caractère personnel.</p>
            </section>

            <section>
                <h2>DONNÉES COLLECTÉES SUR MON SITE</h2>
                <p>Je collecte et conserve certaines données à caractère personnel vous concernant (c’est-à-dire les informations qui permettent de vous identifier directement ou indirectement) ci-après « Données personnelles », et ce, uniquement lorsque vous les communiquez volontairement sur mon Site.</p>
                <p>Je traite notamment, vos nom, prénom, adresse électronique, adresse IP, etc.</p>
                <p>Je peux être amené à vous demander de me communiquer des Données personnelles, notamment dans les cas suivants :</p>
                <ol>
                ...
                <p>Je participe et suis conforme à l’ensemble des Spécifications et Politiques du Transparency & Consent Framework de l’IAB Europe. J’utilise la Consent Management Platform n°92.</p>
                <p>Vous pouvez modifier vos choix à tout moment en cliquant sur le bouton ci-dessous.</p>

                <div>
                    <button>Contrôlez l'utilisation de vos données</button>
                </div>
            ...
            <section>
                <h2>DESTINATAIRE DES DONNÉES PERSONNELLES
                </h2>
            ...
            <section>
                ...
                <p>Je conserverai vos Données personnelles pendant la durée nécessaire ou pour la durée requise par la loi en vigueur.
            ...
            <section>
                <h2>VOS DROITS</h2>
                <p>Conformément à la loi « Informatique et Libertés » du 6 janvier 1978 (art. 34), vous disposez d’un droit d’accès, de modification, de rectification et de suppression des données qui vous concernent. Pour exercer ce droit, vous pouvez me contacter par mail à l’adresse contact@cris-vrancea.fr ou par courrier à l’adresse : <strong>Cris Vrince , 21 avenue de la Republique, 94100 Saint Maur</strong></p>
            ...
            <section>
                <h2>SÉCURITÉ</h2>
                <p>La sécurité de vos Données personnelles est très importante pour moi. Les données personnelles recueillies sur le site www.cris-vrancea.fr sont traitées selon des protocoles sécurisés qui limitent considérablement les risques d’interception ou de récupération par des tiers.</p>
